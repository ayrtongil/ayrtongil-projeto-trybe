...
- Data para entrega final do projeto: `08/05/2023 14:00`.
...
- Use o comando: `git clone git@github.com:tryber/sd-033-a-project-lessons-learned.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-033-a-project-lessons-learned`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-033-a-project-lessons-learned**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-033-a-project-lessons-learned/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-033-a-project-lessons-learned/pulls) e confira que o seu _Pull Request_ está criado
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH33-A&template=betrybe/sd-0x-project-lessons-learned)
