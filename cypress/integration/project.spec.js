...
describe('1 - Adicione uma cor de fundo específica à página', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('8 - Crie um artigo sobre o seu aprendizado', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('9 - Crie uma tag HTML `aside` que contenha uma breve descrição sobre você', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('11 - Teste se a semântica da sua página está aprovada pelo site CodeSniffer', () => {
